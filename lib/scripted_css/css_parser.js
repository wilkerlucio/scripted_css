...
case 35:this.$ = $$[$0];
break;
case 36:this.$ = new yy.MultiValue($$[$0], ", ");
break;
case 37:this.$ = [$$[$0-2], $$[$0]];
break;
...
break;
case 41:this.$ = new yy.HexnumberNode($$[$0]);
break;
case 42:this.$ = new yy.UnitNumberNode($$[$0]);
break;
case 43:this.$ = new yy.NumberNode($$[$0]);
break;
...
break;
case 56:this.$ = new yy.MultiValue($$[$0], " ");
break;
case 57:this.$ = [$$[$0-1], $$[$0]];
break;
...
(function() {
  var AttributeNode, AttributeSelectorNode, AttributeSet, CssAST, FunctionNode, HexnumberNode, ImportantNode, LiteralNode, MetaNode, MetaSelectorNode, MultiValue, NamedArgumentNode, NumberNode, RuleNode, RulesNode, SelectorNode, StringNode, UnitNumberNode, collectStrings;
  ...
  CssAST = {
    ...
    AttributeNode: AttributeNode = (function() {
      ...
      AttributeNode.prototype.groupMultiValues = function() {
        var currentGroup, groups, item, value, _i, _j, _len, _len2, _ref, _ref2;
        groups = [];
        currentGroup = [];
        _ref = this.values;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
