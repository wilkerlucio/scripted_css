...
typeof window=='undefined'&&(window={});var Functional=window.F=window.Functional||{};Functional.install=function(except){var source=Functional,target=window;for(var name in source)
